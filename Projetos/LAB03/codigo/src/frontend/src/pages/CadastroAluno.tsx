    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-slate-50">
      <div className="max-w-6xl mx-auto py-12 px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          <div className="hidden md:flex flex-col justify-center px-8 py-12 rounded-lg bg-gradient-to-br from-violet-600 to-pink-600 text-white shadow-lg">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <div className="text-sm opacity-90">Cadastre-se como aluno e comece a receber reconhecimento</div>
              </div>
            </div>
            <h3 className="text-3xl font-extrabold leading-tight mb-4">Participe da comunidade</h3>
            <p className="opacity-90">Crie sua conta para acompanhar saldo, histórico e resgatar vantagens.</p>
          </div>
          ...
          <div className="flex items-center justify-center">
            <div className="w-full max-w-md bg-white rounded-xl shadow-xl p-8">
              <div className="text-center mb-6">
                ...
                <h2 className="text-2xl font-semibold mt-3">Criar conta de aluno</h2>
              ...
              <form onSubmit={handleSubmit} className="grid md:grid-cols-2 gap-4">
                ...
                <div className="md:col-span-2 flex justify-between items-center">
                  <div className="text-sm text-slate-500">Já tem conta? <a className="text-sky-600 hover:underline" href="/login">Entrar</a></div>
